            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground flex items-center gap-4">
                            <span className="flex items-center gap-1">
                                <Clock className="size-3" /> {questionData.questionType?.timeLimit ? `${Math.floor(questionData.questionType.timeLimit / 60)} mins` : '10 mins'}
                            </span>
                            <span className="flex items-center gap-1">
                    ...
                    <AccessGate isPremium={questionData.isPremium} userTier={userTier}>
                        <div className="bg-white dark:bg-[#1e1e20] border border-gray-100 dark:border-white/5 rounded-2xl p-6 shadow-sm min-h-[400px]">
                            ...
                            <WritingPracticeClient
                                ...
                                timeLimit={questionData.questionType?.timeLimit || 600}
                            />
                        </div>
                    </AccessGate>
                </div>
                ...
                <div className="space-y-6">
                    <div className="bg-blue-50/50 dark:bg-blue-900/10 rounded-xl p-6 border border-blue-100 dark:border-blue-900/20">
                        <h3 className="font-bold text-blue-900 dark:text-blue-100 mb-2">Writing Tips</h3>
                        <p className="text-sm text-blue-700 dark:text-blue-300 leading-relaxed mb-2">
                            <strong>Summarize Text:</strong> Write exactly one sentence between 5 and 75 words.
                        </p>
                        <p className="text-sm text-blue-700 dark:text-blue-300 leading-relaxed">
                            <strong>Write Essay:</strong> Structure your essay with Introduction, Body Paragraphs, and Conclusion. Aim for 200-300 words.
                        </p>
                    </div>
                </div>
            </div>
