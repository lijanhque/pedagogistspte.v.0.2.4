...
export default async function WritingQuestionListPage({ params }: PageProps) {
  ...
  return (
    <QuestionListTable
      ...
      questions={questions}
      basePath={`/academic/practice/writing/${questionTypeCode}`}
      backLink="/academic/practice/writing"
      title="Back to Writing Practice"
    />
  );
}
