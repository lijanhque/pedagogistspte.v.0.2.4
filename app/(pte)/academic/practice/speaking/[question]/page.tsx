...
export default async function SpeakingQuestionListPage({ params }: PageProps) {
    ...
    return (
        <QuestionListTable
            ...
            questions={questions}
            basePath={`/academic/practice/speaking/${questionTypeCode}`}
            backLink="/academic/practice/speaking"
            title="Back to Speaking Practice"
        />
    )
}